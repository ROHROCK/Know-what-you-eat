    ...
    render(){
        return(
            <div>
			   ...
			   <form id="custom-form" className="text-center Login.loginClass form-signin" onSubmit={e => this.submitForm(e)}>
				<h1 className="h3 mb-3 font-weight-normal">Please Register</h1>
					...
					value={this.state.password} required placeholder="Enter password"/>
					<input className="form-control" type="password" name="passwordReEntered" onChange={e => this.change(e)} 
					value={this.state.passwordReEntered} required placeholder="Re-enter password"/>
